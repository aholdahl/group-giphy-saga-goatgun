...
router.get('/', (req, res) => {
  let queryText = `SELECT "favorite"."id", "favorite"."url", "category"."name" AS "category" FROM "favorite" LEFT JOIN "category" ON "favorite"."category_id" = "category"."id" ORDER BY "favorite"."id" DESC;`
